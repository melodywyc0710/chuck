...
export const ROOM_ITEMS: RoomItem[] = [
  ...
  { id: 'rabbit',   name: 'Rabbit',   emoji: '🐰', cost: 12,   category: 'pet', description: '2 ⭐/hr · 11% baby chance',  unlocked: false, placed: false, position: { x: 30, y: 60 }, levelRequired: 2 },
  { id: 'duck',     name: 'Duck',     emoji: '🦆', cost: 18,   category: 'pet', description: '2 ⭐/hr · 11% baby chance',  unlocked: false, placed: false, position: { x: 40, y: 60 }, levelRequired: 3 },
  { id: 'goat',     name: 'Goat',     emoji: '🐐', cost: 30,   category: 'pet', description: '3 ⭐/hr · 10% baby chance',  unlocked: false, placed: false, position: { x: 50, y: 60 }, levelRequired: 4 },
  { id: 'sheep',    name: 'Sheep',    emoji: '🐑', cost: 45,   category: 'pet', description: '3 ⭐/hr · 10% baby chance',  unlocked: false, placed: false, position: { x: 60, y: 60 }, levelRequired: 5 },
  { id: 'pig',      name: 'Pig',      emoji: '🐷', cost: 60,   category: 'pet', description: '4 ⭐/hr · 9% baby chance',   unlocked: false, placed: false, position: { x: 70, y: 60 }, levelRequired: 6 },
  { id: 'cow',      name: 'Cow',      emoji: '🐄', cost: 80,   category: 'pet', description: '5 ⭐/hr · 9% baby chance',   unlocked: false, placed: false, position: { x: 80, y: 60 }, levelRequired: 7 },
  { id: 'deer',     name: 'Deer',     emoji: '🦌', cost: 110,  category: 'pet', description: '6 ⭐/hr · 8% baby chance',   unlocked: false, placed: false, position: { x: 20, y: 60 }, levelRequired: 8 },
  { id: 'horse',    name: 'Horse',    emoji: '🐴', cost: 150,  category: 'pet', description: '8 ⭐/hr · 7% baby chance',   unlocked: false, placed: false, position: { x: 30, y: 60 }, levelRequired: 9 },
  { id: 'fox',      name: 'Fox',      emoji: '🦊', cost: 200,  category: 'pet', description: '10 ⭐/hr · 7% baby chance',  unlocked: false, placed: false, position: { x: 40, y: 60 }, levelRequired: 10 },
  { id: 'peacock',  name: 'Peacock',  emoji: '🦚', cost: 280,  category: 'pet', description: '12 ⭐/hr · 6% baby chance',  unlocked: false, placed: false, position: { x: 50, y: 60 }, levelRequired: 11 },
  { id: 'panda',    name: 'Panda',    emoji: '🐼', cost: 380,  category: 'pet', description: '15 ⭐/hr · 5% baby chance',  unlocked: false, placed: false, position: { x: 60, y: 60 }, levelRequired: 12 },
  { id: 'llama',    name: 'Llama',    emoji: '🦙', cost: 500,  category: 'pet', description: '18 ⭐/hr · 5% baby chance',  unlocked: false, placed: false, position: { x: 70, y: 60 }, levelRequired: 13 },
  { id: 'zebra',    name: 'Zebra',    emoji: '🦓', cost: 650,  category: 'pet', description: '22 ⭐/hr · 4% baby chance',  unlocked: false, placed: false, position: { x: 80, y: 60 }, levelRequired: 14 },
  { id: 'elephant', name: 'Elephant', emoji: '🐘', cost: 850,  category: 'pet', description: '27 ⭐/hr · 4% baby chance',  unlocked: false, placed: false, position: { x: 20, y: 60 }, levelRequired: 15 },
  { id: 'phoenix',  name: 'Phoenix',  emoji: '🔥', cost: 1100, category: 'pet', description: '33 ⭐/hr · 3% baby chance',  unlocked: false, placed: false, position: { x: 30, y: 60 }, levelRequired: 16 },
  { id: 'tiger',    name: 'Tiger',    emoji: '🐯', cost: 1400, category: 'pet', description: '40 ⭐/hr · 3% baby chance',  unlocked: false, placed: false, position: { x: 40, y: 60 }, levelRequired: 17 },
  { id: 'griffin',  name: 'Griffin',  emoji: '🦅', cost: 1800, category: 'pet', description: '50 ⭐/hr · 2% baby chance',  unlocked: false, placed: false, position: { x: 50, y: 60 }, levelRequired: 18 },
  { id: 'dragon',   name: 'Dragon',   emoji: '🐉', cost: 2500, category: 'pet', description: '65 ⭐/hr · 1.5% baby chance', unlocked: false, placed: false, position: { x: 60, y: 60 }, levelRequired: 19 },
  { id: 'unicorn',  name: 'Unicorn',  emoji: '🦄', cost: 5000, category: 'pet', description: '85 ⭐/hr · 1% baby chance',  unlocked: false, placed: false, position: { x: 70, y: 60 }, levelRequired: 20 },
