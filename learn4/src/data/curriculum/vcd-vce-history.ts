...
export const vcdVceHistory: Session[] = [
  ...
  // ─── SESSION: DESIGN FIELDS AND CONTEXTS ─────────────────────────────────
  {
    id: 'vcd-vce-h02',
    subject: 'vcd',
    title: 'Design Fields: Message, Object, Environment & Interactive Experience',
    victorianCode: 'VCAA-VCD-FIELDS',
    description: 'Understand the four VCAA 2024 design fields — Message, Object, Environment and Interactive Experience Design — their defining characteristics, drawing methods and analysis approaches.',
    yearLevel: 11,
    estimatedMinutes: 60,
    starsAvailable: 5,
    color: '#5b21b6',
    ...
    steps: [
      {
        id: 'vcd-vce-h02-s1',
        type: 'worked-example',
        title: 'The Four VCAA 2024 Design Fields',
        teacherNote: 'The VCAA 2024 study design identifies FOUR design fields: Message, Object, Environment and Interactive Experience. "Communication," "Industrial" and "Environmental" are the old terminology — use the correct 2024 terms in exam responses.',
        imagePrompt: 'four design fields diagram showing message design poster branding, object design product packaging, environment design interior architecture, interactive experience design app interface, VCAA 2024 VCD educational poster',
        content: {
          heading: 'Four Fields — the VCAA 2024 Design Field Terminology',
          body: [
            {
              label: 'Message Design',
              text: 'Message Design (previously called Communication or Graphic Design) produces visual communications that convey ideas, information and emotion to audiences. Includes: posters, advertising, brand identities, logos, packaging graphics, editorial design (books, magazines), signage, and print communications. Key concerns: audience, message clarity, visual hierarchy, typography, imagery and how visual language communicates meaning. Drawing methods: layout, typography, illustration, photography.',
              highlight: 'blue',
            },
            {
              label: 'Object Design',
              text: 'Object Design (previously called Industrial or Product Design) produces three-dimensional physical objects that can be manufactured. Includes: furniture, appliances, vehicles, medical devices, packaging structures, tools, consumer electronics and fashion/wearable design. Key concerns: ergonomics (fit to the human body), materials, manufacturing methods, form and function. Drawing methods: isometric projection, orthographic projection (working drawings), two-point perspective for product visualisation.',
              highlight: 'green',
            },
            {
              label: 'Environment Design',
              text: 'Environment Design (previously called Environmental or Architectural Design) creates designed spaces and built environments that people move through and inhabit. Includes: architecture, interior design, exhibition design, retail environments, set design, wayfinding systems, landscape design and public space design. Key concerns: spatial relationships, human movement and behaviour through space, materials and structures, lighting, and the experience unfolding over time. Drawing methods: planometric drawing, one-point interior perspective.',
              highlight: 'orange',
            },
            {
              label: 'Interactive Experience Design (NEW field in 2024)',
              text: 'Interactive Experience Design is the new fourth field in the VCAA 2024 study design — it did not exist in the previous version. It encompasses design for digital products, interfaces, services and interactive systems that users engage with dynamically. Includes: websites, apps, user interfaces (UI), user experience design (UX), interactive installations, digital wayfinding, and service design. Key concerns: user behaviour, navigation, information architecture, interaction patterns, accessibility, and how the experience changes as the user interacts. Gestalt principles are particularly important in interactive design conventions.',
              highlight: 'purple',
            },
          ],
          questions: [
            { q: 'What is the VCAA 2024 term for what was previously called "Communication Design" or "Graphic Design"?', a: 'Message Design — the VCAA 2024 study design uses "Message" as the field name for visual communications including posters, branding, advertising, editorial and packaging graphics.' },
            { q: 'Why is Interactive Experience Design a significant addition to the VCAA 2024 study design?', a: 'Interactive Experience Design recognises that digital products (apps, websites, interfaces) are now a major design field that requires different knowledge and skills from traditional print-based communication design. The field addresses how users interact dynamically with design over time, including UX, navigation, information architecture and accessibility — all increasingly essential to contemporary design practice.' },
          ],
        },
      },
      {
        id: 'vcd-vce-h02-s2',
        type: 'quiz',
        title: 'Quiz: The Four VCAA 2024 Design Fields',
        teacherNote: 'Exam questions will use the 2024 field names — students who use old terminology ("communication design," "industrial design") may not be credited.',
        questions: [
          { id: 'vcd-vce-h02-q1', text: 'A designer creates a new app for public transport users in Melbourne — showing real-time arrivals and allowing route planning. This work belongs to which VCAA 2024 design field?', image: null, options: ['Message Design', 'Object Design', 'Environment Design', 'Interactive Experience Design'], correct: 3, explanation: 'Interactive Experience Design covers digital products, apps, interfaces and systems that users interact with dynamically. A transport app is a digital interactive experience — users engage with it to accomplish tasks, and the design must support intuitive navigation and clear information presentation.' },
          { id: 'vcd-vce-h02-q2', text: 'A design brief asks for a new ergonomic office chair with sustainable materials. This falls within which VCAA 2024 design field?', image: null, options: ['Message Design', 'Object Design — the deliverable is a 3D manufactured physical object', 'Environment Design', 'Interactive Experience Design'], correct: 1, explanation: 'Object Design covers three-dimensional physical products that are manufactured. An office chair involves ergonomics, materials, form and function — all Object Design concerns.' },
          { id: 'vcd-vce-h02-q3', text: 'A poster campaign for a Melbourne music festival, including social media graphics and print posters, belongs to which VCAA 2024 field?', image: null, options: ['Message Design — it produces visual communications conveying ideas and information to an audience', 'Object Design', 'Environment Design', 'Interactive Experience Design'], correct: 0, explanation: 'Message Design produces visual communications — posters, advertising, brand graphics and social media content are all Message Design outcomes. The field focuses on how visual language communicates to audiences.' },
          { id: 'vcd-vce-h02-q4', text: 'Which design field is described as "new" in the VCAA 2024 study design?', image: null, options: ['Message Design', 'Object Design', 'Environment Design', 'Interactive Experience Design'], correct: 3, explanation: 'Interactive Experience Design is the new fourth field added in the VCAA 2024 study design — it recognises the growing importance of digital product design, UX, apps and interactive systems as a distinct design discipline.' },
        ],
      },
      {
        id: 'vcd-vce-h02-s3',
        ...
        teacherNote: 'Technical drawing conventions are examined in Section A and Section C of the VCE exam. Students must recognise the drawing type and understand what it shows and which field it suits.',
        imagePrompt: 'technical drawing conventions chart showing isometric oblique planometric one-point two-point perspective orthographic drawings with field labels, VCE visual communication design educational reference poster',
        content: {
          heading: 'Each Field Has Its Own Drawing Language',
          body: [
            {
      ...
      },
      {
        ...
        teacherNote: 'Use VCAA 2024 field names — Message, Object, Environment, Interactive Experience. Students benefit from analysing work across all four fields.',
        prompt: 'Select ONE design work from at least THREE of the four VCAA 2024 fields (Message, Object, Environment, Interactive Experience) — describe the work, identify the field using correct 2024 terminology, and explain what design considerations would have been central.',
        fields: [
          {
            id: 'message',
            label: 'Message Design example — what is it, who is the audience, what design elements/principles were central?',
            placeholder: 'e.g. The Greenpeace "Save the Arctic" campaign poster — audience: environmentally engaged citizens aged 20-50, central considerations: image selection, typographic hierarchy for the message, colour palette communicating urgency. Principles used: scale (large photograph dominates), contrast (white text on dark image), hierarchy (image first → headline second → CTA third)...',
            multiline: true,
            minRows: 4,
          },
          {
            id: 'object',
            label: 'Object Design example — what is it, who is the user, what design considerations were central?',
            placeholder: 'e.g. The Herman Miller Aeron chair — user: office workers in sustained computer work sessions, central considerations: ergonomics (spinal support, adjustability for diverse body sizes), material selection (mesh for breathability), form as a 3D object...',
            multiline: true,
            minRows: 4,
          },
          {
            id: 'environment_interactive',
            label: 'Environment Design OR Interactive Experience Design example',
            placeholder: 'e.g. Environment: Melbourne\'s NGV gallery spaces — visitors move through curated spatial sequences, wall colours frame artworks without competing, lighting is designed to avoid UV damage... OR Interactive: The Myki app — users navigate tap-on/tap-off, balance and journey history; hierarchy guides users to the most frequent action (check balance) immediately...',
            multiline: true,
            minRows: 4,
          },
        ],
      },
      {
        id: 'vcd-vce-h02-s6',
        type: 'homework',
        title: 'Homework: Four VCAA 2024 Design Fields in Your Environment',
        teacherNote: 'Design is everywhere — this task asks students to identify and classify designed things using correct VCAA 2024 field names.',
        dueNext: false,
        tasks: [
          { id: 'hw1', label: 'Photograph four designed things in your everyday life — one from each VCAA 2024 field (Message, Object, Environment, Interactive Experience) — and annotate why each belongs to its field', hint: 'Message: a poster/packaging/sign. Object: a product you use. Environment: a space you are in. Interactive Experience: an app or website. Use correct 2024 field names in your annotations.' },
          { id: 'hw2', label: 'Practise one type of technical drawing: complete an isometric drawing of a simple object (a book, a phone, a box of tissues)', hint: 'Set up the 30° angles with a set square or protractor — keep all parallel edges truly parallel and maintain consistent scale throughout' },
          { id: 'hw3', label: 'Research one designer working in Interactive Experience Design and write 150 words on what design considerations drive their work — how is it different from Message or Object Design?', hint: 'Look at UX designers at companies like Canva, Atlassian, or Airbnb — they deal with navigation, information architecture, interaction patterns and accessibility rather than purely visual aesthetics' },
        ],
      },
    ],
  },
